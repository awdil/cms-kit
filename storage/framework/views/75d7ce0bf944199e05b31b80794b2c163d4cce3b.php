                    ...
                    <form method="POST" enctype="multipart/form-data" id="guestticket_form" name="guestticket_form">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" placeholder="<?php echo e(lang('Email')); ?>" name="email" id="email"  required>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" id="validateemail"><?php echo e(lang('Verify Your Email')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH D:\xampp\htdocs\complaint-ticketing-system\resources\views/guestticket/guestmodal.blade.php ENDPATH**/ ?>