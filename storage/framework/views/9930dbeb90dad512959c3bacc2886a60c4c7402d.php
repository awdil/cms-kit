        ...
        <?php $__env->stopSection(); ?>
							...
							<div class="page-header d-xl-flex d-block">
								<div class="page-leftheader d-flex">
									<h4 class="page-title"><span class="font-weight-normal text-muted ms-2"><?php echo e(lang('Canned Response Create')); ?></span></h4>
								</div>
							</div>
							<!--End Page header-->
                            <div class="row">
                                <div class="col-xl-7 col-lg-12 col-md-12">
                                    <div class="card">
                                        <div class="card-header border-0 d-flex">
                                            <h4 class="card-title"><?php echo e(lang('Canned Response Create')); ?></h4>
                                        ...
                                        <form action="<?php echo e(route('admin.cannedmessages.store')); ?>" method="POST" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>

                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="" class="form-label"><?php echo e(lang('Canned Response Title')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="form-label"><?php echo e(lang('Canned Response Message')); ?></label>
                                                    <textarea  name="message" class="form-control summernote <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  rows="8" cols="50"></textarea>
                                            ...
                                            <div class="table-responsive tr-lastchild">
                                                <table class="table mb-0 table-information">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="w-50 text-bold"><?php echo '{{app_name}}' ?></span>
                                                            </td>
                                                            <td>:</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="w-50 text-bold"><?php echo '{{site_url}}' ?></span>
                                                            </td>
                                                            <td>:</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="w-50 text-bold"><?php echo '{{ticket_id}}' ?></span>
                                                            </td>
                                                            <td>:</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="w-50 text-bold"><?php echo '{{ticket_user}}' ?></span>
                                                            </td>
                                                            <td>:</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="w-50 text-bold"><?php echo '{{ticket_title}}' ?></span>
                                                            </td>
                                                            <td>:</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="w-50 text-bold"><?php echo '{{ticket_priority}}' ?></span>
                                                            </td>
                                                            <td>:</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="w-50 text-bold"><?php echo '{{user_reply}}' ?></span>
                                                            </td>
                                                            <td>:</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="w-50 text-bold"><?php echo '{{user_role}}' ?></span>
                                                            </td>
                                                            <td>:</td>
                                                            <td>
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\complaint-ticketing-system\Modules/Uhelpupdate\Resources/views/cannedmessages/create.blade.php ENDPATH**/ ?>