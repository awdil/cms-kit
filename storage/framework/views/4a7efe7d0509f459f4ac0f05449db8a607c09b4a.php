                ...
                <div class="table-responsive spruko-delete">
                    ...
                    <table class="table table-bordered border-bottom text-nowrap ticketdeleterow w-100" id="myassignedticket">
                        ...
                        <tbody id="refresh">
                            ...
                            ?>
                            <?php if(Auth::id() && $tickets->status != 'Closed'): ?>
                            <?php if($inarray): ?>
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\cms-kit\resources\views/admin/assignedtickets/myassignedticket.blade.php ENDPATH**/ ?>