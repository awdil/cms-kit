           ...
           <!--- End Trashed Ticket For Admin -->
            ...
            <li class="slide">
                <a class="side-menu__item"  href="<?php echo e(route('admin.bussinesshour.index')); ?>">
                    ...
                    <span class="side-menu__label"><?php echo e(lang('Bussiness Hours', 'Menu')); ?></span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu custom-ul">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Emailtoticket Access')): ?>

                    <li><a href="<?php echo e(route('admin.emailtoticket')); ?>" class="slide-item"><?php echo e(lang('Email to Tickets',
                            'Menu')); ?></a></li>
                    <?php endif; ?>
...
<!--aside closed-->
<?php /**PATH D:\xampp\htdocs\complaint-ticketing-system\resources\views/includes/admin/verticalmenu.blade.php ENDPATH**/ ?>