			...
			<div class="page-main">
					...
					<div class="app-content main-content">
						<div class="side-app">
							...
							<?php if(setting('mail_host') == 'smtp.mailtrap.io' && optional(Auth::user()->getRoleNames())->first() == 'superadmin'): ?>
								<div class="alert alert-warning sprukoclosebtn mt-5 fs-15">
									...
									<div class="">
										...
										<a href="" class="btn btn-dark btn-sm mt-2" target="_blank"> <i class="fa fa-link me-2 fs-15" aria-hidden="true"></i><?php echo e(lang('Setup Reference ')); ?></a>
									</div>
								</div>
							<?php endif; ?>
                            ...
                            <?php if($cronworking != true && optional(Auth::user()->getRoleNames())->first() == 'superadmin'): ?>
...
<?php /**PATH D:\xampp\htdocs\complaint-ticketing-system\resources\views/layouts/adminmaster.blade.php ENDPATH**/ ?>