                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card ">
                                    <div class="card-header border-0">
                                        <h4 class="card-title"><?php echo e(lang('Create Group')); ?></h4>
                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="custom-controls-stacked d-md-flex" >
                                                            <select multiple="multiple" class="form-control select2 " data-placeholder="<?php echo e(lang('Select Employee')); ?>" name="user_id[]" id="username" >
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\cms-kit\resources\views/admin/groups/create.blade.php ENDPATH**/ ?>